...
import { Form,  DatePickerInput, FileUploader, FormLabel } from '@carbon/react'
import { SelectItem, TimePicker, SelectItemGroup, TextInput, TextArea as TextArea } from '@carbon/react'
import { ModalWrapper, Select, NumberInput, TimePickerSelect } from '@carbon/react'
...
onClick={handleValidate}
        ...
        <Form aria-label="create event form" style={{padding:'20px'}}>
...
export default CreateEventModalBase
